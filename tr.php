...
<body>
    <!-- header starts -->
    <header class="w-100" style="background:url(images/prject_img/slider2.jpg); background-size:cover;">
        <div class="p2">
            <div class="container">
                ...
                <div class="about_hero text-center">
                    <p class="stag wht">HOME <span class="diml stag px1">TOUR</span></p>
                    <h1 class="wht jumbo bold6">Destination</h1>
                </div>
            </div>    
        </div> 
    </header>     
                                ...
                                <div class="svc_card svc_card--2 p-0 bora ">
                                    ...
                                    <div class="pxy3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3 aic">
                                                <button class="card2_btn">Discover</button>
                                            </div>
                                        </div>
                                    </div>  
                                </div>
