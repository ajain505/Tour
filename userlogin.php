                 ...
                 <!-- form section -->
                    ...
                    <div class="col-md-4 cont_card  bod pxy1">
                        ...
                        <div class="col-md-12 col-12 bod">
                                ...
                                <input type="text" class="cont_input" name="user" placeholder="Username" required>
                            </div>
                            <div class="col-md-12 col-12 bod m3">
                                <div>
                                    <label for="pass" class="bold5 lbl">Password:</label>
                                </div>
                                <input type="password" class="cont_input" name="pass" placeholder="Password" required>
                            </div>
                        </div>
                        <div class="m2">
                        ...
                        <div>
                                <p class="wht mtag txtc">Don't have account? <a href="signup.php"> Sign Up</a></p>
                        </div>
                </form> 
                    <!--form section end-->
                </div>
